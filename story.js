...
sentence += "'s when it's a minute away from " + verb;
var secondVerb = prompt('Please enter a verb');
sentence += " and there's this electricity in the air, you can almost " + secondVerb;
var noun = prompt('please enter a noun');
sentence += " it. And this " + noun;
...
var FourthNoun = prompt('Please type in a noun');
sentence += ", ever. Video's a poor excuse, I know. But it helps me remember - I need to remember. Sometimes, there's so much " + fourthNoun;
var bodyPart = prompt('please enter a body part');
alert("Ready to see your Mad Libs?");
sentence += " in the world - I feel like I can't take it, like my " + bodyPart + " is just going to cave in.</h2>";
